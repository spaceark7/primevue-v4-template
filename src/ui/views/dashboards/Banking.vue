<template>
      ...
      <div class="flex flex-column sm:flex-row align-items-center gap-4">
        <div class="flex flex-column sm:flex-row align-items-center gap-3">
          <img
            ...
            class="w-4rem h-4rem flex-shrink-0"
          />
  ...
  <div class="w-full md:w-1/2 xl:w-1/3 px-2 mb-4">
      <div class="card h-full">
        ...
        <div class="text-900 text-2xl text-primary mb-5 font-bold">
          $1.500,00
        </div>
        <div class="flex align-items-center justify-content-between">
  ...
  <div class="w-full md:w-1/2 xl:w-1/6 px-2 mb-4">
      <div
  ...
  <div class="w-full xl:w-1/3 px-2 mb-4">
      <div class="card">
  ...
  <div class="w-full xl:w-2/3 px-2 mb-4">
      <div class="card h-full">
      ...
      <div class="card h-full">
        ...
        <div class="flex flex-column row-gap-3">
          <div class="flex flex-column lg:flex-row gap-3">
            <div
              class="w-full lg:w-6 p-3 border-1 border-round surface-border flex align-items-center hover:surface-100 cursor-pointer border-radius"
            >
              <img
                alt="avatar"
                src="/demo/images/avatar/circle/avatar-f-1.png"
                class="w-2rem flex-shrink-0 mr-2"
              />
          ...
          <div class="flex flex-column lg:flex-row gap-3">
            ...
            <div
              class="w-full lg:w-6 p-3 border-1 border-round surface-border flex align-items-center hover:surface-100 cursor-pointer"
            >
              <img
                alt="avatar"
  ...
  <div class="w-full lg:w-1/2 px-2 mb-4">
      <div class="card">
        ...
        >
          <Column field="name" header="Name" class="white-space-nowrap w-4">
          </Column>
          ...
          <Column field="date" header="Date" class="white-space-nowrap w-4">
          </Column>
          <Column
            field="inventoryStatus"
            header="Status"
            class="white-space-nowrap w-4 text-right"
          >
            <template #body="{ data }">
