  ...
  <div class="flex flex-wrap -mx-2">
          ...
          <div class="w-6">
            <svg width="100%" viewBox="0 0 258 96" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                ...
                :style="{ strokeWidth: '2px', stroke: 'var(--primary-color)' }" stroke="10" />
            </svg>
          </div>
        </div>
      </div>
    ...
    <div class="w-full md:w-1/2 xl:w-1/4 px-2 mb-4">
      <div class="card h-full">
        ...
        <div class="flex justify-between align-items-start mt-3">
          <div>
          ...
          <div>
            <Knob v-model="knobValue" readonly :strokeWidth="2" :size="90" class="-mt-5"></Knob>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="w-full xl:w-3/4 px-2 mb-4">
      <div class="card h-full">
        <div class="flex align-items-start justify-content-between mb-6">
          <span class="text-900 text-xl font-semibold">
            Revenue Overview
          </span>
          <Dropdown :options="weeks" v-model="selectedWeek" class="w-10rem" :optionLabel="(option) => option.label()"
    ...
    <div class="w-full lg:w-7/12 px-2 mb-4">
      <div class="card">
        <div class="flex flex-column md:flex-row md:align-items-start md:justify-between mb-3">
          ...
          <div class="inline-flex align-items-center">
            ...
            <Button icon="pi pi-upload" class="p-button-rounded mx-3 export-target-button" v-tooltip="'Export'"
              @click="exportCSV"></Button>
          </div>
        </div>
        <DataTable ref="salesTableRef" :value="products" dataKey="id" paginator :rows="5" class="datatable-responsive"
          globalFilter="{globalFilterValue}" emptyMessage="No products found." responsiveLayout="scroll"
          ...
          <Column field="inventoryStatus" header="Status" sortable :headerStyle="{ minWidth: '10rem' }">
            <template #body="{ data }">
              ...
              <span :class="'product-badge status-' + data.inventoryStatus.toLowerCase()
...
const onWeekChange = () => {
  const newBarData = { ...barData.value } as any;
