<template>
  <div class="card">
    ...
    <p class="text-700 text-xl mt-0 mb-4 p-0">
      Your order is on the way. It&lsquo;ll be shipped today. We&lsquo;ll inform
      you.
    </p>
    <div
      :style="{
      ...
      <ul class="list-none p-0 m-0">
        ...
        >
          ...
          <div class="flex flex-column">
            <span class="text-900 font-semibold text-xl mb-2">{{
              product.name
            }}</span>
            <span class="text-700 font-medium mb-3">
  ...
  <div class="card">
    ...
    <div
      class="flex flex-column md:flex-row md:align-items-center border-bottom-1 surface-border py-5"
    >
      <img
      ...
      <div class="flex-auto mt-3 md:mt-0">
        ...
        <div class="font-medium text-2xl text-900 mt-3 mb-5">
          Order Processing
        </div>
        <div
          class="border-round overflow-hidden surface-300 mb-3"
          :style="{ height: '7px' }"
        >
        ...
        <div class="flex w-full justify-content-between">
          ...
          <span class="text-900 font-medium text-xs sm:text-base"
            >Processing</span
          >
