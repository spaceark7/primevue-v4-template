<template>
  <div class="card">
    ...
    <div
      ...
      :key="i"
      class="surface-card grid grid-nogutter border-round shadow-2 mb-6"
    >
      <div class="col-12 flex p-2 surface-100 border-round-top">
        ...
        <Divider
          align="center"
          layout="vertical"
          class="h-full mx-0 lg:mx-3 surface-border"
        ></Divider>
        <div class="p-2 flex-auto text-center md:text-left">
      ...
      <div class="col-12">
        ...
        >
          ...
          >
            ...
            <div class="flex flex-column my-auto text-center md:text-left">
              ...
              <a
                v-ripple
                tabindex="0"
                class="p-ripple p-2 select-none cursor-pointer w-10rem mx-auto lg:mx-0 border-round font-medium text-center border-1 border-primary text-primary transition-duration-150"
              >
          ...
          <Divider
            ...
            class="w-full block lg:hidden surface-border"
          ></Divider>
        </div>
      </div>
