<template>
        ...
        <div class="p-2">
          <div class="shadow-2 p-4 surface-card border-round">
            <div class="relative mb-3">
              <span
                class="surface-card text-900 shadow-2 px-3 py-2 absolute"
                :style="{ borderRadius: '1.5rem', left: '1rem', top: '1rem' }"
              >
                Category
              </span>
              <img :src="product.image" class="w-full" :alt="i.toString()" />
            </div>
  ...
  <div class="card">
    <div class="grid -mt-3 -ml-3 -mr-3">
      <div
        v-for="(product, i) in products2"
        :key="i"
        class="col-12 md:col-6 lg:col-3 mb-5 lg:mb-0"
      >
