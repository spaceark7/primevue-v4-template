<template>
  ...
  <div
    class="px-5 min-h-screen flex justify-center items-center -mt-8 sm:mt-0"
  >
    <div class="z-1 text-center">
      <div class="text-900 font-bold text-8xl mb-4">
        <!-- {{ i18n.global.t('error_pages.access_denied') }} -->
        Access Denied
      </div>
      <p class="line-height-3 mt-0 mb-5 text-700 text-xl font-medium">
        You do not have permission to access this page.
      </p>
      <AppGoToDashboard :buttonClass="'p-button-help'" />
    </div>
  </div>
</template>
